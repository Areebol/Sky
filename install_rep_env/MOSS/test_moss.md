...
- [MOSS](#moss)
  - [目录](#目录)
  - [:spiral\_notepad: 开源清单](#spiral_notepad-开源清单)
    - [模型](#模型)
    - [数据](#数据)
    - [工程方案](#工程方案)
  - [:fountain\_pen: 介绍](#fountain_pen-介绍)
  - [:robot: 本地部署](#robot-本地部署)
    - [硬件要求](#硬件要求)
    - [使用示例](#使用示例)
      - [单卡部署（适用于A100/A800）](#单卡部署适用于a100a800)
      - [多卡部署（适用于两张或以上NVIDIA 3090）](#多卡部署适用于两张或以上nvidia-3090)
      - [模型量化](#模型量化)
      - [插件增强](#插件增强)
      - [网页Demo](#网页demo)
      - [Api Demo](#api-demo)
      - [命令行Demo](#命令行demo)
      - [通过API调用MOSS服务](#通过api调用moss服务)
  - [:fire: 微调](#fire-微调)
    - [软件依赖](#软件依赖)
    - [使用方法](#使用方法)
  - [:link: 友情链接](#link-友情链接)
  - [:construction: 未来计划](#construction-未来计划)
  - [:page\_with\_curl: 开源协议](#page_with_curl-开源协议)
  - [:heart: 致谢](#heart-致谢)
...
```bash
python moss_cli_demo.py --model_name fnlp/moss-moon-003-sft --gpu 0,1,2,3,4,5,6,7
```
